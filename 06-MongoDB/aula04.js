...
db.inscricoes.update(
	{"_id" : ObjectId("5fb813921e2c9130bcff3625")},
	{
		$set: {
			"localizacao": {
...
db.coordenadas.aggregate( [ { $geoNear: { "near": {	"coordinates": [-20.388008, -54.577546], "type": "Point"}, "distanceField": "distancia.calculada", "spherical": true, "num": 4 } } ] )
