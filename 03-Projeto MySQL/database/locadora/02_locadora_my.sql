...
CREATE TABLE IF NOT EXISTS `locadora`.`dvds` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_dvs_1_idx` (`id_filme` ASC),
  CONSTRAINT `fk_dvs_1`
    FOREIGN KEY (`id_filme`)
    REFERENCES `locadora`.`filmes` (`id`)
    ON DELETE NO ACTION
...
CREATE TABLE IF NOT EXISTS `locadora`.`emprestimos` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_emprestimos_idx` (`id_cliente` ASC),
  CONSTRAINT `fk_emprestimos`
...
-- -----------------------------------------------------
-- Table `locadora`.`filmes_devolucoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `locadora`.`filmes_devolucoes` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_devolucao` INT NOT NULL,
  `id_filmes_emprestimo` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_filmes_devolucoes_1_idx` (`id_devolucao` ASC),
  INDEX `fk_filmes_devolucoes_2_idx` (`id_filmes_emprestimo` ASC),
  CONSTRAINT `fk_filmes_devolucoes_1`
    FOREIGN KEY (`id_devolucao`)
    REFERENCES `locadora`.`devolucoes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_filmes_devolucoes_2`
    FOREIGN KEY (`id_filmes_emprestimo`)
